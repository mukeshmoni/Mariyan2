...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((10, 10), "𝗔𝗗𝗜𝗧𝗬 𝗠𝗨𝗦𝗜𝗖", fill="white", font = font1, align ="left") 
            image4.text((670, 150), "𝗔𝗗𝗜𝗧𝗬 𝗠𝗨𝗦𝗜𝗖", fill="white", font = font2, stroke_width=2, stroke_fill="yellow", align ="left") 
