...
from Mariyan.utils.database import get_authuser_names, get_cmode
from Mariyan.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Mariyan.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Vishnu.stop_stream(message.chat.id)
    except:
        pass
