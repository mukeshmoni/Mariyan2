...
from Mariyan.utils import get_readable_time
from Mariyan.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
                                       remove_banned_user)
from Mariyan.utils.decorators.language import language
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAAEGL5FjVmKIr_LweYZkKFudvTvZlMB1DAAC9AQAAo5XqVe-XL4OKXPHgCoE")
